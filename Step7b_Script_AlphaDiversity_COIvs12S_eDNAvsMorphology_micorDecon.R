...
t <- seq(1, 500, by=15)
iNext_Fish_track6_1 <- iNEXT(ps_Fish[,colnames(ps_Fish) == "ftTrack6_1"], q=c(0,1), datatype="abundance", size=t) #knot = 40, 
...
seqtab_morph_Fish <- as.data.frame(t(ps_morph_Fish))
seqtab_morph_Fish$Zone <- smpl_morph_Fish$Zones
