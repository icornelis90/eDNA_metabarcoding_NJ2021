...
#upload data
table_rarefied <- readxl::read_excel(paste0(proj.path,"/MiFish_UE-S_concatenated/results/table_rarefied_CleanedASVs_FullTaxonomicAssignment_original.xlsx"),sheet = "table_rarefied_CleanedASVs_Full")
table_morph <- readxl::read_excel(paste0(proj.path,"/Step5_Statistics/Morphology_Abundancy_Raw.xlsx"),sheet = "Fish")
