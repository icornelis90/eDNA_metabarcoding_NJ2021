...
#upload data
#table_rarefied <- readxl::read_excel(paste0(proj.path,"/OWFvsCoastal_concatenated/results/Decontam/table_rarefied_CleanedASVs_FullTaxonomicAssignment_WithField.xlsx"))
table_rarefied <- readxl::read_excel(paste0(proj.path,"/OWFvsCoastal_concatenated/results/Decontam/table_unrarefied_concatenated_CleanedASVs_FullTaxonomicAssignment_WithField.xlsx"))
...
merged_data_rarefied_Animalia <- merged_data_rarefied_Animalia[,colorder]

#(rm(table_rarefied_Animalia, merged_data_rarefied_Animalia, taxo))
```
...
data_soorten <- as.data.frame(t(merged_data_rarefied_Animalia))
